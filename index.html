  ...
  <body>
    ...
    <div class="off-canvas-wrapper">
      ...
      <div class="off-canvas-content" data-off-canvas-content>
        <!-- welcome screen -->
        <section id="top" class="row expanded welcome-screen" style="background-image:url(images/welcome-screen/IMG_9136.jpg);" data-top-top="transform:translateY(-20px)" data-top-bottom="transform:translateY(320px)"><!-- change background-image with yours -->
          <div class="column">
        ...
        <section id="the-couple" class="row expanded couple custom-paralax beach">
          ...
          <div class="body">
            ...
            <div class="row picture-frame">
              <div class="people1">
                <div class="thumbnail thumbnail-line thumbnail-circle thumbnail-xs"><img alt="Abdul" src="images/content/people1.jpg"></div>
              ...
              <div class="frame-wrapper">
                <div class="frame">
                  <img alt="Abdul & Ika" src="images/content/IMG_9343.JPG">
                </div>
              </div><!-- end frame couple wedding/prewedding shoot -->
              <div class="people2">
                <div class="thumbnail thumbnail-line thumbnail-circle thumbnail-xs"><img alt="Ika" src="images/content/people2.jpg"></div>
        ...
        <section class="row expanded carousel-container">
          ...
          <div class="carousel-5">
            <div class="item">
              <img alt="" src="images/content/t1.JPG">
            </div>
            <div class="item">
              <img alt="" src="images/content/t2.JPG">
            </div>
            <div class="item">
              <img alt="" src="images/content/t3.JPG">
            </div>
            <div class="item">
              <img alt="" src="images/content/t4.JPG">
            </div>
            <div class="item">
              <img alt="" src="images/content/t5.JPG">
            </div>
            <div class="item">
              <img alt="" src="images/content/t6.JPG">
            </div>
            <div class="item">
              <img alt="" src="images/content/t7.JPG">
            </div>
          </div>
        </section>
        ...
        <section id="events" class="row blog-container">
          <div class="column body">
            ...
            <div class="blog">
              <!-- eachpost 1 start -->
              <div class="each-post">
                <div class="thumbnail thumbnail-xxl"><img alt="" src="images/content/tunangan.jpeg"></div>
                <div class="content">
                  <h3>Akad Nikah</h3>
                  <div class="meta-post">
                    <span class="location">
              ...
              <!-- eachpost 2 start -->
              <div class="each-post">
                <div class="thumbnail thumbnail-xxl"><img alt="" src="images/content/24-square.jpg"></div>
                <div class="content">
                  <h3>Resepsi</h3>
                  <div class="meta-post">
                    <span class="location">
          ...
          <div class="column body">
            ...
            <div class="row carousel-container">
              ...
              <div class="carousel-5">
                <div class="item">
                  <!-- item 1 -->
                  <img alt="" src="images/content/w4-sq.jpg">
                ...
                <div class="item">
                  <!-- item 2 -->
                  <img alt="" src="images/content/w6-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       White 2
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 3 -->
                  <img alt="" src="images/content/w3-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       White 3
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 4 -->
                  <img alt="" src="images/content/w1-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       White 4
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 5 -->
                  <img alt="" src="images/content/w5-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       White 5
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 5 -->
                  <img alt="" src="images/content/w2-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                      White 6
                      <span class="social-media">
            ...
            <div class="row carousel-container">
              ...
              <div class="carousel-5">
                <div class="item">
                  <!-- item 1 -->
                  <img alt="" src="images/content/br1-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                      Brown 1
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 2 -->
                  <img alt="" src="images/content/br2-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       Brown 2
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 3 -->
                  <img alt="" src="images/content/br3-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       Brown 3
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 4 -->
                  <img alt="" src="images/content/br4-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       Brown 4
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 5 -->
                  <img alt="" src="images/content/br5-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       Brown 5
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 5 -->
                  <img alt="" src="images/content/br6-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       Brown 6
                      <span class="social-media">
            ...
            <div class="row carousel-container">
              ...
              <div class="carousel-5">
                <div class="item">
                  <!-- item 1 -->
                  <img alt="" src="images/content/b2-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       Black 1
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 2 -->
                  <img alt="" src="images/content/b1-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       Black 2
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 2 -->
                  <img alt="" src="images/content/b6-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       Black 3
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 3 -->
                  <img alt="" src="images/content/b3-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       Black 4
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 4 -->
                  <img alt="" src="images/content/b4-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       Black 5
                      <span class="social-media">
                ...
                <div class="item">
                  <!-- item 5 -->
                  <img alt="" src="images/content/b5-sq.jpg">
                  <div class="hover-item">
                    <div class="desc">
                       Black 6
                      <span class="social-media">
            ...
            <div id="grid" class="row galleries">
              ...
              <figure class="gallery column large-6 medium-6 small-12" data-groups='["white"]'>
                <a href="//www.youtube.com/watch?v=xKrusvtUa6g" data-lity>
                  <img src="images/content/tb1.jpg" alt="">
              ...
              <figure class="gallery column large-6 medium-6 small-12" data-groups='["white"]'>
                <a href="//www.youtube.com/watch?v=_CHE9J32wXc" data-lity>
                  <img src="images/content/tb2.jpg" alt="">
                  <div class="label-wrapper">
